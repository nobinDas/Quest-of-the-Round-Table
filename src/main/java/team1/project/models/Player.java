...
public class Player {
    ...
    private int shields;
    private ArrayList<AdventureCard> inHandCards = new ArrayList<>(); // 12 adventure cards
    private ArrayList<AdventureCard> inPlayCards = new ArrayList<>(); // Cards in play, Amours + Allies + Rank
    ...
    public String toString(){
        ...
        for(AdventureCard ac: inHandCards){
            result += ac.toString()+"\n";
        }
        return result;
    }
