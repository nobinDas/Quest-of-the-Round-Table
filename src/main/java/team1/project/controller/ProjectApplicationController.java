...
//        return ResponseEntity.ok(gameService.createGame(player));
    ...
    public ResponseEntity<ArrayList<ArrayList<AdventureCard>>> begin(@RequestBody String gameId) throws InvalidParamException {
        log.info("begin game request: {} ",gameId);
        System.out.println("BEGIN GAME");

        Game gamer = gameService.beginGame(gameId);

        ArrayList<ArrayList<AdventureCard>> cards = new ArrayList<>();
        ...
        ResponseEntity<ArrayList<ArrayList<AdventureCard>>> send = ResponseEntity.ok(cards);
        return send;
    ...
    public ResponseEntity<ArrayList<AdventureCard>> sendPile(){
        log.info("Send discard pile");
        Game gamer = gameService.returnGame();
        ArrayList<AdventureCard> discardPile = gamer.getDiscardedAdventureCardList();
    ...
    public ResponseEntity<ArrayList<ArrayList<AdventureCard>>> sendAdventureCard(@RequestBody PlayerRequest player){
...
//        ResponseEntity<StoryCard> send = ResponseEntity.ok(card);
    ...
    public ResponseEntity<StoryCard> sendStoryCard(@RequestBody PlayerRequest player){
...
//        ResponseEntity<StoryCard> send = ResponseEntity.ok(card);
    ...
    public ResponseEntity<ArrayList<ArrayList<AdventureCard>>> discard(@RequestBody cardRequest request) throws InvalidParamException {
...
//        return ResponseEntity.ok(gameService.createGame(player));
    ...
    public ResponseEntity<ArrayList<ArrayList<AdventureCard>>> selectAlly(@RequestBody cardRequest request) throws InvalidParamException {
    ...
    public ResponseEntity<ArrayList<ArrayList<AdventureCard>>> discardCards(@RequestBody discardCardsRequest request) throws InvalidParamException {
        log.info("discard card request: {} ",request);
        System.out.println("DISCARDING CARD");
